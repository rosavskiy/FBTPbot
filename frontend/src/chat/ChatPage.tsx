  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: 'assistant',
      content:
        'Здравствуйте! Я — ИИ-ассистент техподдержки Фармбазис. Задайте мне вопрос по работе с программой, и я постараюсь помочь. Если не смогу найти ответ — передам ваш вопрос оператору.',
    },
  ])
    ...
    try {
      ...
      setMessages(prev => [
        ...prev,
        {
          role: 'assistant',
          content:
            'Произошла ошибка при обработке запроса. Пожалуйста, попробуйте ещё раз или обратитесь к оператору.',
        },
      ])
    } finally {
      setLoading(false)
    ...
    <div className="chat-page">
      ...
      {showEscalation && !escalationSent && (
        <div className="chat-escalation">
          <p>
            🔔 Не удалось найти точный ответ. Хотите связаться с оператором техподдержки?
          </p>
          <input
            type="text"
